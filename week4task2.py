...
#     print(f"Name: {name}\nAge: {age}")
# #assigining new name to the function
# show_student=display_student
# #calling the function with new name
# show_student('Crystal', 18)
...
#     return len(myList)
# length=logic()
# print(f"the number of character in a string:{length}")
